<?php
	...
	define("_SITENAME_",'Pos');
	define("_SITENAME_NO_CAPS_",'pos');
	define("_SITENAME_CAPS_",'POS');

	$is_live = true;  // for live dfault
	
	if(isset($_SERVER['SERVER_NAME'])) {
		if($_SERVER['SERVER_NAME'] == "localhost" || $_SERVER['SERVER_NAME'] == "192.168.0.8") {
	...
	if($is_live)
	{
		  ...
		  define('WEB_HOST_NAME','93.178.3.230:8888');
		  $baseUrl.=WEB_HOST_NAME;	
		  define('SITE_NAME','');
		  define('FILE_UPLOAD', '/home/byptserv/www/pos/assets/upload/');
		  define('FILE_PATH','/home/byptserv/www/pos/');
		  define('DEFAULT_FILE_PATH','/home/byptserv/www/pos/');
		  define('LOGS_PATH','/home/byptserv/www/dlogs/');
		  define('DB_SERVER', '192.168.0.201');
		  define('DB_SERVER_USERNAME', 'byptserv_byptser');
		  define('DB_SERVER_PASSWORD', 'Bypt@2012');
		  define('DB_DATABASE', 'byptserv_pos');
	...
	else
	{
		...
		$baseUrl.=WEB_HOST_NAME.'/pos';	
		$filename="D:/wamp/www/pos";
		$filename1="/opt/lampp/htdocs/jobtaxi/html/index.php";
		
		if (file_exists($filename)) {
			
			define('FILE_UPLOAD', 'D:/wamp/www/pos/assets/upload/');
			define('FILE_PATH','D:/wamp/www/pos/');
			define('LOGS_PATH','D:/wamp/www/pos/dlogs/');
		  	define('DEFAULT_FILE_PATH','D:/wamp/www/pos/');
		}
		...
		{
			define('FILE_UPLOAD', 'E:/wamp/www/pos/assets/upload/');
			define('FILE_PATH','E:/wamp/www/pos/');
			define('LOGS_PATH','E:/wamp/www/pos/dlogs/');
		  	define('DEFAULT_FILE_PATH','E:/wamp/www/pos/');
		}
		...
		define('MAIL_SERVER_USERNAME', 'pos@gmail.com');
