...
class ShrinkQuantity extends CActiveRecord
{
	...
	public function rules()
	{
		...
		/*return array(
			array('admin_id, store_id, product_id, system_qnt, actual_qnt, qnt_difference', 'numerical', 'integerOnly'=>true),
			array('created', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, admin_id, store_id, product_id, system_qnt, actual_qnt, qnt_difference, created', 'safe', 'on'=>'search'),
		);*/
	}
