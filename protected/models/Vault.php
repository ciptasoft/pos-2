...
class Vault extends CActiveRecord
{
	...
	function getVaultDetails($shift_id)
	{
		...
		$sql = "select sum(withdraw) as withdraw,sum(deposite) as deposite from vault where cashier_id = ".Yii::app()->session['userId']." and date = '".date("Y-m-d")."' and shift_id = ".$shift_id."";
