...
function getSearch()
{
	...
	$j.ajax({
		type: 'POST',
		url: '<?php echo Yii::app()->params->base_path;?>user/productList',
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="productdata"  id="list" style="background-color:#FFF;" width="100%">
    	<tr style="font-size:14px; font-stretch:normal;">
    		<th width="35%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;"> 
                ...
                <a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/productList/sortType/<?php echo $ext['sortType'];?>/sortBy/product_name' >
            ...
            <?php /*?><th width="29%">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/productList/sortType/<?php echo $ext['sortType'];?>/sortBy/product_desc' >
                Product Description
				<?php 
            ...
            <th width="16%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php  Yii::app()->params->base_path;?>user/productList/sortType/<?php echo $ext['sortType'];?>/sortBy/product_price' >
            ...
            <th width="20%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/productList/sortType/<?php echo $ext['sortType'];?>/sortBy/quantity' >
            ...
            <th width="20%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/productList/sortType/<?php echo $ext['sortType'];?>/sortBy/upc_code' >
                ##_BTN_UPC_CODE_##
				<?php 
            ...
            <?php /*?><th width="13%">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/productList/sortType/<?php echo $ext['sortType'];?>/sortBy/manufacturing_date' >
                Manufactured Date
				<?php 
           ...
           <?php /*?> <th width="13%">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/productList/sortType/<?php echo $ext['sortType'];?>/sortBy/expiry_date' >
                Expiry Date
				<?php 
		...
		if(count($data) > 0){ $i=0;
            ...
            <tr style="font-size:14px; font-stretch:normal;">
            	<td class="" align="left">
                <a href="#" onClick="loadBoxContent('<?php echo Yii::app()->params->base_path ; ?>user/ticketListForProduct/product_id/<?php echo $row['product_id'] ?>/product_name/<?php echo $row['product_name'] ?>','secondcont')">
                ...
                <td class="" align="right">
                <a href="#" onClick="loadBoxContent('<?php echo Yii::app()->params->base_path ; ?>user/quantityDetailForProduct/product_id/<?php echo $row['product_id'] ?>/product_name/<?php echo $row['product_name'] ?>','secondcont')">
                	<?php echo $row['quantity'];?>
                </a>
                </td>				
                <td class="" align="right">
                	<?php echo $row['upc_code'];?>
                </td>
                ...
                <td class=""  align="center">
                	<a href="<?php echo Yii::app()->params->base_path;?>user/productDescription/id/<?php echo $row['product_id'];?>" lang="<?php echo $row['product_id'];?>" id="viewMore_<?php echo $row['product_id'];?>" class="viewIcon noMartb viewMore " title="##_MY_LISTS_VIEW_##">
                    </a>
