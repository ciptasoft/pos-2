...
<?php echo CHtml::beginForm(Yii::app()->params->base_path.'user/editProfile','post',array('id' => 'frm_edit_profile','name' => 'frm_edit_profile','style'=>"padding:0px; margin:0px;")) ?>

    <div>
        <div class="colLeft"  style="margin-left:300px;">
            <div class="field">
                <label>##_MY_PROFILE_FULL_NAME_## <span id="fullnameerror"></span></label>
                <input type="text" name="fName" maxlength="18" class="textbox width119" id="fName" value="<?php if(isset($data['firstName'])){ echo $data['firstName']; } ?>" onblur="validatefName();" onkeyup="validatefName();"/>
                <input type="text" name="lName" maxlength="18" class="textbox width119" id="lName" value="<?php if(isset($data['lastName'])){ echo $data['lastName']; } ?>" onblur="validatelName();" onkeyup="validatelName();" />
            </div>
            <div class="field">
