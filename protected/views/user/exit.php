...
<div class="mainContainer" style="height:100%;background-color:#222222;">
    ...
    <div class="content">
      <input type="hidden" id="mainPageCheker" value="1" />
       <div class="RightSide">	
            <div class="clear"></div>
          <h1 style="color:white; margin-top:100px;">##_EXIT_PAGE_SHIFT_DETAILS_##</h1>
          	 <?php echo CHtml::beginForm(Yii::app()->params->base_path.'user/logout','post',array('id' => 'functionForm','name' => 'functionForm')) ?>
                        ...
                        <td width="100%">
                           <table style="background-color:#6AA566; padding:10px;" width="100%" cellspacing="1" height="50%">
                                ...
                                <tr>
                                    ...
                                    <td  align="left"><input style="width:240px;" class="textbox" type="text" id="cash_out" name="cash_out" value="0" /></td>
