...
<div>
	<h3 class="reddot">
        <p>Daily Sales<div class="addtext"><a href="#" onclick="$j('#mainContainer').load('<?php echo Yii::app()->params->base_path;?>user/AddTodoList');" title="##_LIST_AJAX_ADD_TODO_##"><img src="<?php echo Yii::app()->params->base_url;?>images/plus.png" alt="" border="0" /></a></div></p>
        <div class="clear"></div>
	</h3>
</div>
<div class="ajaxBox todoLists">
    ...
    <div class="viewport" style=" <?php if(count($data)==1){?>height:128px !important;<?php } elseif(count($data)==2){?>height:160px !important;<?php } elseif(count($data)==3){?>height:160px !important;<?php } elseif(count($data) >  3){?> height:200px !important; <?php } else { ?>height:30px !important;<?php } ?>">
        <div class="overview">
         ...
         <img src="<?php echo Yii::app()->params->base_url;?>images/graph.png" width="250px" height="148px" />
          <?php /*?>  <ul class="hire-list items list-items">
                <li id="list_request_0" class="listItem activeListItems">
                    <a href="javascript:reloadHomeByListAjax('0');">
                        <div class="hire-data" style="width:53%;">
                            <div>
                                <p class="title">
                                    <b><span id="list_request_name_0">Daily Sales</span></b>
                                </p>
                            </div>
                            <div>
                                <p class="post"></p>
