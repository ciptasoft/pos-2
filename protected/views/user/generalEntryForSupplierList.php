...
function getSearch()
{
	...
	$j.ajax({
		type: 'POST',
		url: '<?php echo Yii::app()->params->base_path;?>user/generalEntrySupplierList/supplier_id/<?php echo $supplier_id ;?>/supplier_name/<?php echo $supplier_name ;?>',
...
<div class="RightSide" style="margin:0 !important;">
    ...
    <div class="productboxgreen">
		<h1 style="color:#333333;">##_SUPP_GEN_ENT_FOR_##&nbsp;<?php echo $supplier_name ;?></h1>
        <div class="clear"></div>
    	...
    	<tr style="font-size:12px; font-stretch:normal;">
    		<th width="11%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;"> 
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/generalEntrySupplierList/supplier_id/<?php echo $supplier_id ;?>/supplier_name/<?php echo $supplier_name ;?>/sortType/<?php echo $ext['sortType'];?>/sortBy/id' >
                ##_BTN_NO_##
				<?php 
            ...
            <th width="21%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/generalEntrySupplierList/supplier_id/<?php echo $supplier_id ;?>/supplier_name/<?php echo $supplier_name ;?>/sortType/<?php echo $ext['sortType'];?>/sortBy/supplier_general_entry.credit' >
                ##_PAY_##
				<?php 
				if($ext['img_name'] != '' && $ext['sortBy'] == 'supplier_general_entry.credit'){ ?>
					<img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
					<?php
				} ?>
                </a>
            ...
            <th width="13%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/generalEntrySupplierList/supplier_id/<?php echo $supplier_id ;?>/supplier_name/<?php echo $supplier_name ;?>/sortType/<?php echo $ext['sortType'];?>/sortBy/supplier_general_entry.debit' >
                 ##_RECEIVE_##
				<?php 
				if($ext['img_name'] != '' && $ext['sortBy'] == 'supplier_general_entry.debit'){ ?>
					<img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
					<?php
				} ?>
                </a>
            ...
            <th width="13%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/generalEntrySupplierList/supplier_id/<?php echo $supplier_id ;?>/supplier_name/<?php echo $supplier_name ;?>/sortType/<?php echo $ext['sortType'];?>/sortBy/supplier_general_entry.paymentType' >
                 ##_PAY_TYPE_##
				<?php 
				if($ext['img_name'] != '' && $ext['sortBy'] == 'supplier_general_entry.paymentType'){ ?>
					<img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
					<?php
				} ?>
                </a>
            ...
            <th width="20%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/generalEntrySupplierList/supplier_id/<?php echo $supplier_id ;?>/supplier_name/<?php echo $supplier_name ;?>/sortType/<?php echo $ext['sortType'];?>/sortBy/supplier_general_entry.createdAt' >
                ##_TICKET_LIST_CREATED_DATE_##
				<?php 
				if($ext['img_name'] != '' && $ext['sortBy'] == 'supplier_general_entry.createdAt'){ ?>
					<img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
					<?php
				} ?>
                </a>
