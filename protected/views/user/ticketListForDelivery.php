...
function getSearch()
{
	...
	$j.ajax({
		type: 'POST',
		url: '<?php echo Yii::app()->params->base_path;?>user/ticketDeliveryStatus',
...
function changeTicketStatus(invoiceId)
{
	$j.ajax({
		type: 'POST',
		url: '<?php echo Yii::app()->params->base_path;?>user/changeTicketStatus',
		data: 'invoiceId='+invoiceId,
		cache: false,
		success: function(data)
		{
			$j("#ticketDeliveryTab").trigger('click');
		}
	});
}

function cancelTicketDelivery(invoiceId)
{
	$j.ajax({
		type: 'POST',
		url: '<?php echo Yii::app()->params->base_path;?>user/cancelTicketDelivery',
		data: 'invoiceId='+invoiceId,
		cache: false,
		success: function(data)
		{
...
<div class="RightSide" style="margin:0 !important;">
    ...
    <?php endif; ?>
		...
		<h1 style="color:#333333;">##_PENDING_MOBILE_ORDER_LIST_##</h1>
        <div class="clear"></div>
  	...
  	<div class="clear"></div>
    	...
    	<tr style="font-size:12px; font-stretch:normal;">
    		<th width="11%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;"> 
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketDeliveryStatus/sortType/<?php echo $ext['sortType'];?>/sortBy/invoiceNo' >
            ...
            <th width="21%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketDeliveryStatus/sortType/<?php echo $ext['sortType'];?>/sortBy/casher' >
            ...
            <th width="13%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketDeliveryStatus/sortType/<?php echo $ext['sortType'];?>/sortBy/total_amount' >
            ...
            <th width="20%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketDeliveryStatus/sortType/<?php echo $ext['sortType'];?>/sortBy/createdAt' >
            ...
            <th width="12%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketDeliveryStatus/sortType/<?php echo $ext['sortType'];?>/sortBy/status' >
		...
		if(count($data) > 0){ $i=0;
            ...
            <tr style="font-size:14px; font-stretch:normal;">
                ...
                <td class="" align="center">
                	<input type="button" class="btn" onclick="changeTicketStatus(<?php echo $row['invoiceId']; ?>)" value="Dispatch" />	        </td>
                <td width="15%" class="lastcolumn">
                    ...
                    <a style="cursor:pointer;" onclick="cancelTicketDelivery(<?php echo $row['invoiceId']; ?>)"  href="#"><img title="##_BTN_CANCEL_##" src="<?php echo Yii::app()->params->base_url;?>images/error-icon.png" /></a>
                    </a>
				</td>
			</tr>
			<?php
