...
<script type="application/javascript"> 
   	function generalEntry() {
		 ...
		 $j.ajax({
		  type: 'POST',
		  url: '<?php echo Yii::app()->params->base_path;?>user/addGeneralEntryforCustomer',
...
<link href="http://localhost/pos/css/style_home.css" rel="stylesheet" type="text/css" />
    ...
    <div id="msgbox1" class="errormsg"><?php echo Yii::app()->user->getFlash('error'); ?></div>
        ...
        <?php endif; ?>
             ...
             <div class="productboxgreen-small">
            	...
            	<h1 style="color:#333333; margin-left:300px;">##_GENERAL_ACCOUNT_ENTRY_CUSTOMER_##</h1>
