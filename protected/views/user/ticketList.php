...
function getSearch()
{
	...
	$j.ajax({
		type: 'POST',
		url: '<?php echo Yii::app()->params->base_path;?>user/ticketList',
...
<div class="RightSide" style="margin:0 !important;">
    ...
    <div class="productboxgreen">
		<h1 style="color:#333333;">##_TICKET_LIST_TICKET_LIST_##</h1>
        <div class="clear"></div>
     ...
     <table cellpadding="0" cellspacing="0" border="0" class="productdata"  id="list" style="background-color:#FFF;" >
    	<tr style="font-size:12px; font-stretch:normal;">
    		<th width="11%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;"> 
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketList/sortType/<?php echo $ext['sortType'];?>/sortBy/invoiceNo' >
            ...
            <?php /*?><th width="14%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;"> 
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketList/sortType/<?php echo $ext['sortType'];?>/sortBy/invoiceId' >
            ...
            <th width="21%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketList/sortType/<?php echo $ext['sortType'];?>/sortBy/casher' >
            ...
            <th width="5%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketList/sortType/<?php echo $ext['sortType'];?>/sortBy/total_amount' >
            ...
            <th width="14%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketList/sortType/<?php echo $ext['sortType'];?>/sortBy/ticket_details.createdAt' >
           ...
           <?php /*?> <th width="12%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketList/sortType/<?php echo $ext['sortType'];?>/sortBy/status' >
               ...
               <?php /*?> <td class="" align="left">
                ...
                <td width="15%" class="lastcolumn">
                	<a href="<?php echo Yii::app()->params->base_path;?>user/ticketDetail/id/<?php echo $row['invoiceId'];?>" lang="<?php echo $row['invoiceId'];?>" id="viewMore_<?php echo $row['invoiceId'];?>" class="viewIcon noMartb viewMore floatLeft" title="##_MY_LISTS_VIEW_##">
                     ...
                     <?php 
                	$filePath =  "assets/upload/invoice/invoice".$row['invoiceId'].".pdf" ;
							if(file_exists($filePath) ) { ?>
                    
                    <a style="cursor:pointer;" target="_blank" href="<?php echo Yii::app()->params->base_url;?>assets/upload/invoice/invoice<?php echo $row['invoiceId'];?>.pdf" lang="<?php echo $row['invoiceId'];?>"><img src="<?php echo Yii::app()->params->base_url;?>images/print.png" title="##_VIEW_INVOICE_##" /></a>
                 <?php } 
				 $filePath1 =  "assets/upload/srinvoice/srinvoice".$row['invoiceId'].".pdf" ;
				 if(file_exists($filePath1) ) { ?>
                 
                    <a style="cursor:pointer;" target="_blank" href="<?php echo Yii::app()->params->base_url;?>assets/upload/srinvoice/srinvoice<?php echo $row['invoiceId'];?>.pdf" lang="<?php echo $row['invoiceId'];?>"><img src="<?php echo Yii::app()->params->base_url;?>images/print.png" title="##_VIEW_RETURN_INVOICE_##" /></a>
