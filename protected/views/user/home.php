...
<div class="mainContainer" style="margin:0px;">
    <div class="content" id="mainContainer" style="width:100%; padding:0px; margin:0px;">
      ...
      <div class="container">
         ...
         <div style="width:890px; min-heigth:699px; overflow:auto; float:left;" id="secondcont">
          ...
          <div class="secondcontmain" id="secondcont1">
 ...
 <div class="cont">##_WINE_ACEDEMY_DESC_##</div>
          ...
          <!--  <a href="#" title="Hold Ticket" class="first"><img src="images/file_icon.png" width="30" height="20"  /></a> -->
            ...
            <div class="greenbox" id="greenbox">
              ...
              <div style="font-size:100px;text-shadow: 2px 2px 3px rgba(0, 0, 0, 0.3);" id="txt"></div>
            ...
            <form name="Calculate">
              <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-size:12px; height:435px !important; ">
                ...
                <tr>
                  ...
                  <td colspan="2" id="ticketDeliveryTab" onClick="loadBoxContent('<?php echo Yii::app()->params->base_path ; ?>user/ticketDeliveryStatus','secondcont')"><b style="color:#333333;">##_MOBILE_ORDERS_##</b></td>
                  <td>&nbsp;</td>
                  <td colspan="2">&nbsp;</td>
                </tr>
              </table>
