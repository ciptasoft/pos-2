...
function getSearch()
{
	...
	$j.ajax({
		type: 'POST',
		url: '<?php echo Yii::app()->params->base_path;?>user/ticketListForProduct/product_id/<?php echo $product_id ; ?>/product_name/<?php echo $product_name ?>',
...
<div class="RightSide" style="margin:0 !important;">
    ...
    <div class="productboxgreen">
		<h1 style="color:#333333;">##_TICKET_LIST_FOR_##&nbsp;<?php echo $product_name;?></h1>
        <div class="clear"></div>
   	 <div class="searchArea innerSearch"  style="padding-right:50px;width: 565px;">
        ...
        <label style="float:left;margin-right:5px;margin-top:5px;font-size:12px; padding-left: 25px;"><b>##_TICKET_LIST_AMOUNT_##</b></label>  	<label class="label floatLeft" style="font-size:12px;">##_TICKET_LIST_FROM_##</label>
    		<select id="searchFrom" style="width:70px;float:left;" name="searchFrom">           	
    		...
    		<select id="searchTo" style="width:70px;float:left;" name="searchTo">            	
            	<option value="">##_TICKET_LIST_SELECT_##</option>           	
            	<option value="10">100</option>           	
            	<option value="5000">5000</option>
                <option value="10000">10000</option>
            ...
            <input type="text" class="textbox floatLeft" name="keyword"  onkeypress="if(event.keyCode==13){getSearch();}" id="keyword" autocomplete="off" style="width:90px !important;" />
            <input type="button" name="searchBtn" class="searchBtn" value="" onclick="getSearch();" />
        </form>
        <div class="clear"></div>
    </div>
	<table style="margin-left: -20px; width:537px !important;" border="0" class="search-table" cellpadding="0" cellspacing="0">
                	<tr><td colspan="8" class="height10"></td></tr>
                    <tr>
                        <td width="20%" align="right"><label style="font-size:12px;"><b>##_ADMIN_START_DATE_## :&nbsp; </b></label></td>
                      	<td width="5%">
                        	<input name="startdate" width="10" id="startdate" style="width:90px !important; height:25px;" class="datebox" type="text" value="<?php if(isset($ext['startdate'])){echo $ext['startdate'];}?>"/>
                        </td>
                        <td width="15%" align="right"><label style="font-size:12px;"><b>##_ADMIN_END_DATE_## :&nbsp;</b></label></td>
						<td width="5%" align="left">
                        	<input name="enddate" width="10" id="enddate" style="width:90px !important; height:25px;" class="datebox" type="text" value="<?php if(isset($ext['enddate'])){echo $ext['enddate'];}?>"/>
                        </td>
                        <td width="15%" align="center">
                        	<input type="button"  name="Search" onclick="getSearch();" value="##_ADMIN_SEARCH_##"  class="btn" />
                        </td>
                        <td width="5%" ><input type="button"  name="" value="##_ADMIN_SHOWALL_##"  onclick="getAllSearch();"  class="btn"  />
                        </td>
                    </tr>
                </table>
                 
        <br/><b style="margin-left:25px !important;"> For Today's Ticket :</b> &nbsp;&nbsp;<input type="checkbox" name="todayCheckbox" id="todayCheckbox" value="1" onclick="getTodayRecord()" ><br/>       
    	...
    	<tr style="font-size:12px; font-stretch:normal;">
    		<th width="11%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;"> 
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketListForProduct/product_id/<?php echo $product_id ; ?>/product_name/<?php echo $product_name ?>/sortBy/invoiceNo' >
           ...
           <?php /*?> <th width="14%"  style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;"> 
            ...
            <th width="13%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketListForProduct/product_id/<?php echo $product_id ; ?>/product_name/<?php echo $product_name ?>/sortBy/total_amount' >
            ...
            <th width="21%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketListForProduct/product_id/<?php echo $product_id ; ?>/product_name/<?php echo $product_name ?>/sortBy/quantity' >
                ##_PRODUCT_QUANTITY_##
				<?php 
            ...
            <th width="20%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketListForProduct/product_id/<?php echo $product_id ; ?>/product_name/<?php echo $product_name ?>/sortBy/createdAt' >
            ...
            <th width="12%" style="border-bottom:1px solid #EEEEEE; border-right:1px solid #EEEEEE;">
            	<a href="javascript:;" class="sort" lang='<?php Yii::app()->params->base_path;?>user/ticketListForProduct/product_id/<?php echo $product_id ; ?>/product_name/<?php echo $product_name ?>/sortBy/status' >
