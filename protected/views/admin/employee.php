...
$j(document).ready(function(){
	$j('.delete_this').click(function(){
		...
		if(confirm("##_ADMIN_DELET_CONFIRM_##")){
			window.location=base_path+"admin/deleteEmployee/id/"+id;
		}
	});
...
<div id="content">
	<div>
		<h1>##_EMPLOYEE_LIST_##</h1>
        
		
        <table width="100%" border="0" class="search-table" cellpadding="2" cellspacing="2">
                	<tr>
                        <td align="right" colspan="8">
                        	<a href="<?php echo Yii::app()->params->base_path;?>admin/addEmployee" class="btn">##_ADD_EMPLOYEE_##</a> 
                			
                		</td>
                    </tr>
                    <?php
                    echo CHtml::beginForm(Yii::app()->params->base_path.'admin/employee/','post',array('id' => 'searchForm','name' => 'searchForm')) ?>
                    ...
                    <tr>
                        ...
                        <td width="9%" align="right">
                        	<input type="button"  name="" value="##_ADMIN_SHOWALL_##"  onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>admin/employee'"  class="btn"  />
                        </td>
                    </tr>
            ...
            <div class="content-box">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="listing" width="960">
                	<tr>
                        ...
                        <th width="20" align="center"><a href="<?php echo Yii::app()->params->base_path;?>admin/employee/sortType/<?php echo $ext['sortType'];?>/sortBy/firstName" class="sort">##_ADMIN_FIRSTNAME_##<?php 
                        ...
                        <th width="20" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/employee/sortType/<?php echo $ext['sortType'];?>/sortBy/lastName' >##_ADMIN_LASTNAME_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'lastName'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                             <th width="10" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/employee/sortType/<?php echo $ext['sortType'];?>/sortBy/email' >##_ADMIN_EMAIL_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'email'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                             <th width="20"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/employee/sortType/<?php echo $ext['sortType'];?>/sortBy/salary' >##_ADMIN_SALARY_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'salary'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?></a></th>
                        <th width="35" class="alignCenter"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/employee/sortType/<?php echo $ext['sortType'];?>/sortBy/created_date' >##_ADMIN_CREATE_DATE_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'created_date'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                      	<th width="35" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/employee/sortType/<?php echo $ext['sortType'];?>/sortBy/modified_date' >##_ADMIN_MODIFY_DATE_##<?php 
						...
						foreach($data['employees']  as $row){ ?>
                            <tr>
                                <?php /*?><td class="alignCenter"> 
                                    <input name="checkbox[]" type="checkbox" onclick="dSelectCheckAll()" id="checkbox<?php echo $row['employee_id'];?>" value="<?php echo $row['employee_id'];?>">
                                </td><?php */?>
                                ...
                                <td class="alignCenter" width="15">
                                    <a href="<?php echo Yii::app()->params->base_path;?>admin/addEmployee/employee_id/<?php echo $row['employee_id'];?>" title="Edit"><img src="<?php echo Yii::app()->params->base_url; ?>images/edit_pencil.png" /> </a>
                                </td>
                                 
                                <td class="alignCenter" width="15">
                                    <a class="delete_this" href="javascript:;"  lang="<?php echo $row['employee_id'];?>" title="Delete">
