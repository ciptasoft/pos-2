...
function getCustomerByDate()
{
	...
	$j.ajax({			
	type: 'POST',
	url:  '<?php echo Yii::app()->params->base_path;?>admin/getDailyCustomerSalesReport',
	data:'date='+date,
	cache: true,
	success: function(data)
	{
		$j(".content-box").html(data);
            ...
            <div id="searchByDate">
                      <table class="search-table" >
                       ...
                       <input type="button" onclick="getCustomerByDate();" value="##_ADMIN_SEARCH_##"  class="btn" style="margin-left:40px;" />
                       </td>
                       </tr>
                       </table>
                      
                       </div>
            <h2><?php if(isset($date)){echo $date ;} else { echo "Today's" ; }?> Customers Purchase Report</h2>
   		  <table cellpadding="0" cellspacing="0" border="0" class="listing" width="960">
                	<tr>
                        <th width="5%">No</th>
                        <th width="10%">Customer Id</th>
                        <th width="10%">Customer Name</th>
                        <th width="10%">Total Purchase Product</th>    
                        <th width="20%">Total Purchase Amount</th>
                       </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;"><?php echo $row['customer_id']; ?></td>
