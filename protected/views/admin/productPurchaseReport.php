...
function getReports(value)
{
	...
	success: function(data)
	{
		...
		$j("#searchDate").css('display','none');
            ...
            <h2>##_PRODUCT_WISE_PUR_REPORT_##</h2>
   		  <table cellpadding="0" cellspacing="0" border="0" class="listing" width="960">
                	<tr>
                        <th width="5%">##_BTN_NO_##</th>
                        <th width="10%">##_BROWSE_PRODUCT_PRODUCT_NAME_##</th>
                        <th width="10%">##_TOTAL_QUANTITY_##</th>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;"><?php echo $row['totalQuantity']; ?></td>
