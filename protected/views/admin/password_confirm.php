    ...
    <?php echo CHtml::beginForm(Yii::app()->params->base_path.'admin/resetpassword','post',array('id' => 'resetpasswordform','name' => 'resetpasswordform','onsubmit' => 'return validateresetform();')) ?>
        <table cellpadding="1" cellspacing="1" border="0" class="login-table">
            ...
            <tr>
                ...
                <td><input type="text" name="token" id="token" class="textbox" onfocus="this.style.color='black';" <?php if( isset($token) ) {?>value="<?php echo $token;?>"<?php }?> /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                	<input type="password" maxlength="20" name="new_password_confirm" id="new_password_confirm"  class="textbox"  onfocus="this.style.color='black';"  />
                </td>
            </tr>
            <tr>
                <td></td>
                <td align="left">
                    <div class="floatLeft">
                        <input type="submit" name="submit_reset_password_btn"  onfocus="this.style.color='black';"  class="btn" value="##_BTN_SUBMIT_##" />
                    </div>
                </td>
            </tr>
        </table>
