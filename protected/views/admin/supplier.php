...
$j(document).ready(function(){
	$j('.delete_this').click(function(){
		...
		if(confirm("##_ADMIN_DELET_CONFIRM_##")){
			window.location=base_path+"admin/deleteSupplier/id/"+id;
		}
	});
...
<div id="content">
	<div>
		<h1>##_SUPPLIER_LIST_##</h1>
        
		
        <table width="100%" border="0" class="search-table" cellpadding="2" cellspacing="2">
                	<tr>
                        <td align="right" colspan="8">
                        	<a href="<?php echo Yii::app()->params->base_path;?>admin/addSupplier" class="btn">##_ADD_SUPPLIER_##</a> 
                			
                		</td>
                    </tr>
                    <?php
                    echo CHtml::beginForm(Yii::app()->params->base_path.'admin/supplier/','post',array('id' => 'searchForm','name' => 'searchForm')) ?>
                    ...
                    <tr>
                        ...
                        <td width="9%" align="right">
                        	<input type="button"  name="" value="##_ADMIN_SHOWALL_##"  onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>admin/supplier'"  class="btn"  />
                        </td>
                    </tr>
            ...
            <div class="content-box">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="listing" width="960">
                	<tr>
                        ...
                        <th width="20" align="center"><a href="<?php echo Yii::app()->params->base_path;?>admin/supplier/sortType/<?php echo $ext['sortType'];?>/sortBy/supplier_name" class="sort">##_SUPPLIER_NAME_##<?php 
                        ...
                        <th width="20" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/supplier/sortType/<?php echo $ext['sortType'];?>/sortBy/email' >##_ADMIN_EMAIL_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'email'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                             <th width="10" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/supplier/sortType/<?php echo $ext['sortType'];?>/sortBy/contact_no' >##_ADMIN_CONTACT_NO_##
							 <?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'contact_no'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                             <th width="20"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/supplier/sortType/<?php echo $ext['sortType'];?>/sortBy/address' >##_ADMIN_ADDRESS_##</a>
                            <?php  if($ext['img_name'] != '' && $ext['sortBy'] == 'address'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                             </th>
                             <th width="35" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/supplier/sortType/<?php echo $ext['sortType'];?>/sortBy/credit' >##_CREDIT_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'credit'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                            <th width="35" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/supplier/sortType/<?php echo $ext['sortType'];?>/sortBy/debit' >##_DEBIT_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'debit'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                             <th width="35" align="center">##_BALANCE_##</th>
                        <th width="35" class="alignCenter"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/supplier/sortType/<?php echo $ext['sortType'];?>/sortBy/created_date' >##_ADMIN_CREATE_DATE_##<?php 
					...
					if($cnt>0){
						...
						foreach($data['supplier']  as $row){ ?>
                            <tr>
                                ...
                                <td  style="text-align:right;"><?php echo $row['contact_no'];?></td>
                                ...
                                <td  style="text-align:right;"><?php echo $row['debit'] - $row['credit'];?></td>
                                ...
                                <td class="alignCenter" width="15">
                                    <a href="<?php echo Yii::app()->params->base_path;?>admin/addSupplier/supplier_id/<?php echo $row['supplier_id'];?>" title="Edit"><img src="<?php echo Yii::app()->params->base_url; ?>images/edit_pencil.png" /> </a>
                                </td>
                                 
                                <td class="alignCenter" width="15">
                                    <a class="delete_this" href="javascript:;"  lang="<?php echo $row['supplier_id'];?>" title="Delete Seeker">
