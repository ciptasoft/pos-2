	...
	<div>
        ...
        <table width="100%" border="0" class="search-table" cellpadding="2" cellspacing="2">
                ...
                >Create Client</a> 
                    ...
                    <?php
                    echo CHtml::beginForm(Yii::app()->params->base_path.'admin/clientUser/email/'.$email,'post',array('id' => 'searchForm','name' => 'searchForm')) ?>
                    ...
                    <tr>
                        ...
                        <td width="9%" align="right">
                        	<input type="button"  name="" value="##_ADMIN_SHOWALL_##"  onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>admin/clientUser/email/<?php echo $email;?>'"  class="btn"  />
                        </td>
                    </tr>
            ...
            <div class="content-box">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="listing" width="960">
                	<tr>
                        ...
                        <th width="20"><a href="<?php echo Yii::app()->params->base_path;?>admin/clientUser/sortType/<?php echo $ext['sortType'];?>/sortBy/firstName/email/<?php echo $email;?>" class="sort">##_ADMIN_FIRSTNAME_##<?php 
                        ...
                        <th width="20"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/clientUser/sortType/<?php echo $ext['sortType'];?>/sortBy/lastName/email/<?php echo $email;?>' >##_ADMIN_LASTNAME_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'lastName'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                             <th width="10"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/clientUser/sortType/<?php echo $ext['sortType'];?>/sortBy/loginId/email/<?php echo $email;?>' >##_CLIENT_PEN_ID_##<?php 
                         ...
                         <th width="35"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/clientUser/sortType/<?php echo $ext['sortType'];?>/sortBy/email/email/<?php echo $email;?>' >##_ADMIN_EMAIL_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'email'){ ?>
                       		 ...
                       		 <th width="35" class="alignCenter"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/clientUser/sortType/<?php echo $ext['sortType'];?>/sortBy/createdAt/email/<?php echo $email;?>' >##_ADMIN_CREATE_DATE_##<?php 
                        ...
                        <th width="15">##_ADMIN_CHANGE_PASS_##</th>
