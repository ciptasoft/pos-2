        ...
        <div class="content-box func-para">
        	<?php echo CHtml::beginForm(Yii::app()->params->base_path.'admin/changeAdminPassword','post',array('id' => 'edit_login','name' => 'edit_login','onsubmit' => 'return validateAll();')) ?>
                <table cellpadding="5" cellspacing="5" border="0" class="search-table" width="100%">
                    ...
                    <?php } ?>
                    <tr>
                        <td align="right">##_PROFILE_OLD_PASSWORD_## :</td>
                        <td>
                    ...
                    <tr>
                        <td width="15%" align="right">##_PROFILE_NEW_PASSWORD_## :</td>
                        <td width="85%">
                    ...
                    <tr>
                        <td align="right">##_PROFILE_CONFIRM_PASSWORD_## :</td>
                        <td>
                    ...
                    if(isset($data['loginIdType']) && $data['loginIdType'] == '0'){?>
                        <tr>
                            <td align="right">##_PROFILE_SEND_MAIL_PASSWORD_## :</td>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input type="submit" name="Save" value="##_ADMIN_SAVE_##" class="btn">
                            <input name="cancel" type="reset"  value="##_ADMIN_CANCEL_##" onclick="window.location.href='<?php echo Yii::app()->params->base_path; ?>admin/changePassword'"  class="btn"/>
                        </td>
                    </tr>
                </table>
