...
<?php endif; ?>
	...
	<h1 class="popupTitle" style="background-color:#6AA566;"><button style="float:left; margin-left:5px;" class="btn" onclick="window.history.go(-1);">Back</button>##_Ticket_DESC_PAGE_TICKET_DETAILS_##</h1>
