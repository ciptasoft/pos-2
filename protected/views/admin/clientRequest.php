	...
	<div>
        ...
        <table width="100%" border="0" class="search-table" cellpadding="2" cellspacing="2">
                ...
                >Create Client</a> 
                    ...
                    <?php } ?>
                    <?php
                    echo CHtml::beginForm(Yii::app()->params->base_path.'admin/clientRequest/','post',array('id' => 'searchForm','name' => 'searchForm')) ?>
                    ...
                    <tr>
                        ...
                        <td width="9%" align="right">
                        	<input type="button"  name="" value="##_ADMIN_SHOWALL_##"  onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>admin/clientRequest/'"  class="btn"  />
                        </td>
                    </tr>
            ...
            <div class="content-box">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="listing" width="960">
                	<tr>
                        ...
                        <th width="40"><a href="<?php echo Yii::app()->params->base_path;?>admin/clientRequest/sortType/<?php echo $ext['sortType'];?>/sortBy/first_name" class="sort">##_CLIENT_NAME_##<?php 
                       ...
                       <th width="10"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/clientRequest/sortType/<?php echo $ext['sortType'];?>/sortBy/total_users' >##_CLIENT_TOTAL_USERS_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'total_users'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                         <th width="35"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/clientRequest/sortType/<?php echo $ext['sortType'];?>/sortBy/email' >##_ADMIN_EMAIL_##<?php 
                          ...
                          <?php /*?>   <th width="35"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/clientRequest/sortType/<?php echo $ext['sortType'];?>/sortBy/totalUsers' >##_CLIENT_TOTAL_REQ_##<?php if($ext['img_name'] != '' && $ext['sortBy'] == 'totalUsers'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th> <?php */?>
                            
                        <th width="35" class="alignCenter"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/clientRequest/sortType/<?php echo $ext['sortType'];?>/sortBy/created_at' >##_ADMIN_CREATE_DATE_##<?php 
                               ...
                               <?php echo $row['email'];?>
                                ...
                                <td class="alignCenter" width="15">
                                 <?php if($row['isVerified'] != 1){?>
                                    <a href="<?php echo Yii::app()->params->base_path;?>admin/approveClient/id/<?php echo $row['id'];?>&ajax=false" title="Active This User"><img src="<?php echo Yii::app()->params->base_url; ?>images/success-icon.png" /> </a>
                                <?php  }else{?>
