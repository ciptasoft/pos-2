...
function getReports(value)
{
	...
	if ( id == 0)
	{
		window.location.href='<?php echo Yii::app()->params->base_path;?>admin/accountsReport';
		return true;
	}
	else if( id == 1)
	{
            ...
            <h2>##_STORE_ACC_REPORT_##</h2>
   		  <table cellpadding="0" cellspacing="0" border="0" class="listing" width="960">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;"><?php echo $row['totalCredit']; ?></td>
                        <td  style="text-align:right;"><?php echo $row['totalDebit']; ?></td>
                   </tr>
                   <?php
                       $i++; $j++; } ?>
