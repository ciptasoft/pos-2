...
<?php endif; ?>   
<div class="mainDiv" >
<h1><a href="#">##_MODULE_PURCHASE_##</a> <img src="<?php echo Yii::app()->params->base_url;?>images/path-arrow.png" alt="" border="0" />&nbsp; ##_HEADER_PURCHASE_RETURN_##</h1>        
        <div class="content-box">
             ...
             <div class="productboxgreen">
              <div style="margin-left:10px;">
                 <div class="btnfield"> 
                 <form method="post" action="<?php echo Yii::app()->params->base_path;?>admin/purchaseReturnView" name="purchaseReturn" id="purchaseReturn" >
