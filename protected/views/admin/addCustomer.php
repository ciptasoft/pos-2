            ...
            <div class="field-area">
                ...
                <div>
                 <select name="rating" id="rating" class="select-box2" style="width:250px;">
               			<option <?php if(isset($result['rating']) && $result['rating'] == "1") { ?> selected="selected" <?php  } ?> value="1" >Rating 1</option>
                        <option <?php if(isset($result['rating']) && $result['rating'] == "2") { ?> selected="selected" <?php  } ?> value="2" >Rating 2</option>
                        <option <?php if(isset($result['rating']) && $result['rating'] == "3") { ?> selected="selected" <?php  } ?> value="3" >Rating 3</option>
                 </select>
