...
<div id="content">
	<div>
		<h1>##_ADMIN_DAILY_REPORTS_##</h1>
        <div id="searchDate" style="display:block;">
        	<table width="100%" border="0" class="search-table" cellpadding="2" cellspacing="2">
                	<?php
                    echo CHtml::beginForm(Yii::app()->params->base_path.'admin/ticketListForProduct/','post',array('id' => 'searchForm','name' => 'searchForm')) ?>
                    ...
                    <tr>
                        ...
                        <td width="9%" align="right">
                        	<input type="button"  name="" value="##_ADMIN_SHOWALL_##"  onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>admin/dailySalesReport'"  class="btn"  />
                        </td>
                    </tr>
		...
		<table width="100%" border="0" class="search-table" cellpadding="2" cellspacing="2">
                	<tr>
                    	<td width="1%">##_ADMIN_REPORT_BY_## :</td>
                        <td colspan="7" width="20%" align="left">
                            ...
                            <option value="4">##_CUSTOMER_WISE_##</option>
                            <option value="5">##_STORE_WISE_##</option>
                            <option value="7">##_PERSON_WISE_##</option>
							</select> 
                	   </td>
                    <tr><td colspan="8" class="height10"></td></tr>
      </table>
      ...
      <?php 
        echo CHtml::beginForm(Yii::app()->params->base_path.'admin/ticketListForProduct/type/All','post',array('id' => 'deleteRecordForm','name' => 'deleteRecordForm','onsubmit' => 'return validateForm();')) ?>
    <div id="product">
            <div class="content-box">
   		  ...
   		  <table cellpadding="0" cellspacing="0" border="0" class="listing" width="960">
                	<tr>
                        ...
                        <th width="10%"><a href="<?php echo Yii::app()->params->base_path;?>admin/dailySalesReport/sortType/<?php echo $ext['sortType'];?>/sortBy/invoiceNo" class="sort"> ##_BROWSE_PRODUCT_INVOICE_NO_##<?php 
                        ...
                        <th width="10%"><a href="<?php echo Yii::app()->params->base_path;?>admin/dailySalesReport/sortType/<?php echo $ext['sortType'];?>/sortBy/invoiceId" class="sort"> ##_TICKET_LIST_INVOICE_ID_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'invoiceId'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                          </a></th>    
                        <th width="20%"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/dailySalesReport/sortType/<?php echo $ext['sortType'];?>/sortBy/casher' >##_TICKET_LIST_CASHIER_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'casher'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                        <th width="15%"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/dailySalesReport/sortType/<?php echo $ext['sortType'];?>/sortBy/total_amount' >##_TICKET_LIST_AMOUNT_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'total_amount'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                        <th width="10%" class="alignCenter"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/dailySalesReport/sortType/<?php echo $ext['sortType'];?>/sortBy/createdAt' >##_TICKET_LIST_CREATED_DATE_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'createdAt'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                      	<th width="20%" class="alignCenter"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/dailySalesReport/sortType/<?php echo $ext['sortType'];?>/sortBy/status' >##_TICKET_LIST_STATUS_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'status'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                        <th width="10%" class="alignCenter">##_TICKET_LIST_ACTION_##</th>
                      </tr>
