...
<!-- Login -->
  ...
  <div align="center">
      <h5>##_HEADER_PURCHASE_RETURN_##</h5>
      <div class="mojone-loginbox">
      <form name="purchaseForm" id="purchaseForm" method="post" action="<?php echo Yii::app()->params->base_path ; ?>admin/submitPurchaseReturn">
                              ...
                              <td>&nbsp;</td>
                                  ...
                                  <table style="border-color:#000099;" width="90%" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#000099" name="purchaseTable" id="purchaseTable">
                                        <tr style="background-color:#EDEAEA;">
                                          ...
                                          <td width="20%" align="center" valign="middle" scope="col"><h2>##_BROWSE_PRODUCT_QUANTITY_##</h2></td>
                                 ...
                                 <table style="border-color:#000099;" width="90%" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#000099">                                           
                                        <tr style="background-color:#EDEAEA;">
                                         <td  colspan="3">&nbsp;&nbsp </td>
                                          <td width="13%" align="right" valign="middle"><h2 style="margin-right:30px;" >##_Ticket_DESC_PAGE_TOTAL_##</h2></td>
