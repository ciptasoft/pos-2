...
<div id="content">
	<div>
        ...
        <table width="100%" border="0" class="search-table" cellpadding="2" cellspacing="2">
                    ...
                    <?php
                    echo CHtml::beginForm(Yii::app()->params->base_path.'admin/product/','post',array('id' => 'searchForm','name' => 'searchForm')) ?>
                    ...
                    <tr>
                        ...
                        <td width="9%" align="right">
                        	<input type="button"  name="" value="##_ADMIN_SHOWALL_##"  onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>admin/product'"  class="btn"  />
                        </td>
                    </tr>
            ...
            <div class="content-box">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="listing" width="960">
                	<tr>
                        ...
                        <th width="20" align="center"><a href="<?php echo Yii::app()->params->base_path;?>admin/product/sortType/<?php echo $ext['sortType'];?>/sortBy/product_name" class="sort">##_PRODUCT_NAME_##
						<?php 
                        ...
                        <th width="20" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/product/sortType/<?php echo $ext['sortType'];?>/sortBy/product_price' >##_PRODUCT_PRICE_## 1<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'product_price'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                            <th width="20" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/product/sortType/<?php echo $ext['sortType'];?>/sortBy/product_price2' >##_PRODUCT_PRICE_## 2<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'product_price2'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                            <th width="20" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/product/sortType/<?php echo $ext['sortType'];?>/sortBy/product_price3' >##_PRODUCT_PRICE_## 3<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'product_price3'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                             <th width="10" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/product/sortType/<?php echo $ext['sortType'];?>/sortBy/upc_code' >##_PRODUCT_UPC_CODE_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'upc_code'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th>
                             <th width="20"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/product/sortType/<?php echo $ext['sortType'];?>/sortBy/quantity' >##_PRODUCT_QUANTITY_##</a>
                            <?php  if($ext['img_name'] != '' && $ext['sortBy'] == 'quantity'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                             </th>
                        <?php /*?> <th width="35" align="center"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/product/sortType/<?php echo $ext['sortType'];?>/sortBy/store_name' >##_STORE_##<?php 
                            if($ext['img_name'] != '' && $ext['sortBy'] == 'store_name'){ ?>
                                <img src="<?php echo Yii::app()->params->base_url;?>images/<?php echo $ext['img_name'];?>" class="sortImage" />
                                <?php
                            } ?>
                            </a></th><?php */?>
                        <th width="35" class="alignCenter"><a class="sort" href='<?php echo Yii::app()->params->base_path;?>admin/product/sortType/<?php echo $ext['sortType'];?>/sortBy/created_date' >##_ADMIN_CREATE_DATE_##<?php 
					...
					if($cnt>0){
						...
						foreach($data['product']  as $row){ ?>
                            <tr>
                                ...
                                <td align="left"><a href="<?php echo Yii::app()->params->base_path;?>admin/ticketListForProduct/product_id/<?php echo $row['product_id'];?>/product_name/<?php echo $row['product_name'];?>/"><?php echo $row['product_name'];?></a></td>
                                <td style="text-align:right;"><?php echo $row['product_price'];?></td>
                                <td style="text-align:right;"><?php echo $row['product_price2'];?></td>
                                <td style="text-align:right;"><?php echo $row['product_price3'];?></td>
                                <td style="text-align:right;"><?php echo $row['upc_code'];?></td>
                                <?php /*?><td style="text-align:right;">
								 <a href="<?php echo Yii::app()->params->base_path ; ?>admin/quantityDetailForProduct/product_id/<?php echo $row['product_id'] ?>/product_name/<?php echo $row['product_name'] ?>">
                                ...
                                <?php /*?><td class="alignCenter"><?php echo $row['store_name'];?></td><?php */?>
